...
public class Printer implements Instruction {
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		// Choix de la primitive d'affichage
		if (this.parameter.getType().equalsTo(AtomicType.BooleanType)) {
		...
		} else if (this.parameter.getType().equalsTo(AtomicType.CharacterType)) {
			...
			throw new SemanticsUndefinedException(
				"Unsupported type for print : " + this.parameter.getType()
			);
		}
		// retour à la ligne après le Print
